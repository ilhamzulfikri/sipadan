                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type='text' class="form-control date" id="jenis_tagihan" name="jenis_tagihan" value="{{$nd->tagihan->jenis_tagihan}}" disabled >
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class='input-group'>
                        <input type='date' class="form-control date" id="tgl_tagihan" name="tgl_tagihan" value="{{$nd->tagihan->tgl_tagihan}}" disabled >
                        <div class="input-group-append">
                          <span class="input-group-text">
                            <span class="fa fa-calendar-o"></span>
                          </span>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control uang" id="nilai_tagihan" name="nilai_tagihan" value="{{$nd->tagihan->nilai_tagihan}}" disabled>
                    </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="ket_tagihan" name="ket_tagihan" rows="2" disabled>{{$nd->tagihan->ket_tagihan}}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
