...
<div class="row">
  <div class="col-sm-12">
    <div class="content-header">INPUT NOTA DINAS</div>
  </div>
</div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      @foreach($unit as $u)
                          <option value='{{ $u->kantor." ".$u->nama }}'>{{ $u->kantor." ".$u->nama }}</option>
                      @endforeach
                     </select>
                    </div>
                  </div>-->
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control-file" id="uploadnotadinas" name="uploadnotadinas" required="required" accept="application/pdf">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="emailAddress4">Upload RAB</label>
                      <input type="file" class="form-control-file" id="uploadrab" name="uploadrab" required="required" accept="application/pdf">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="videoUrl2">Upload Justifikasi (Opsional)</label>
                      <input type="file" class="form-control-file" id="uploadjustifikasi" name="uploadjustifikasi" accept="application/pdf">
                    </div>
                    </div>
                  </div>
