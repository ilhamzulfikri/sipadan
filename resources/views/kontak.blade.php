          ...
          @endif
            ...
            <table class="table table-striped compact">
              ...
              @foreach($notadinas as $nd)
                <tr>
                  <td>
                      <a class="btn mr-1 mb-1 btn-primary btn-sm" href="{{ url('monitoring') }}/{{ $nd->id }}"> {{ $nd->no_notadinas }}</a>
                  </td>
                  <td><p class="text-uppercase">{{ $nd->pekerjaan }}</p></td>
                  <!--
                  ...
                  <td>
                    @if(isset($nd->kontrak->id))
                        ...
                        <span class="badge badge-success text-uppercase">Pekerjaan</span>
                        @else
                    ...
                    @elseif(isset($nd->hpe->id))
                        <span class="badge badge-secondary text-uppercase">Lelang Kontrak</span>
                    @else
                        <span class="badge badge-danger text-uppercase">Pembuatan RKS</span>
                    @endif
                  </td>
                  <!--
                  <td>
