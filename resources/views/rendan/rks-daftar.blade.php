            ...
            <!--<table class="table table-bordered file-export">
              <table class="table display nowrap table-striped scroll-horizontal">-->
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      @if(Session::get('bidang') == 'REN')
                      <a class="btn mr-1 mb-1 btn-danger btn-sm" href="{{ url('rks') }}/{{ $nd->id }}"> <i class="fa ft-edit-2"></i></a>
                      @else
                      <a class="btn mr-1 mb-1 btn-danger btn-sm" href="#" data-toggle="popover" data-content="Menu ini hanya dapat diakses oleh user RENDAN"
