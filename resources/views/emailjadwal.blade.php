...
@if($tombolsimpan == "Simpan")
<p>Telah dilakukan <b>perubahan jadwal pengadaaan</b> dengan keterangan sebagai berikut :</p>
<table id="A" style="border-collapse: collapse;table-layout:fixed;padding: 20px; border:1px solid #e3e3e3;border-radius: 5px;" class="table">
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td>{{ $j->ket_pembukaan_penawaran }}</td>
                </tr>
                <tr>
                  ...
                  <td>{{ $j->ket_evaluasi_penawaran }}</td>
                </tr>
                @if($metode == "Lelang Terbuka")
                <tr>
                ...
                <tr>
                  ...
                  <td>{{ $j->ket_pembuktian_penawaran }}</td>
                </tr>
                @endif
                <tr>
                ...
                <tr>
                  ...
                  <td>{{ $j->ket_upload_ba_pengadaan }}</td>
                </tr>
                <tr>
                  ...
                  <td>{{ $j->ket_penetapan_pemenang }}</td>
                </tr>
                <tr>
                  ...
                  <td>{{ $j->ket_pengumuman_pemenang }}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>{{ $j->ket_teken_kontrak }}</td>
                </tr>
              @endforeach
              </tbody>
</table>
@elseif($tombolsimpan == "Gagal")
<p>Pekerjaan tersebut dilakukan <font color="red"><b>{{$tindakan}}</b></font> dengan alasan <b>{{ $ketgagal}}.</b></p>
@else
<p>Pekerjaan tersebut sudah selesai ditahap pembuatan jadwal pengadaan dan selanjutnya masuk ketahap <b>input kontrak</b> oleh pelaksana pengadaan.</p>
@endif
