...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>Login SIPADAN - Sistem Informasi Pengadaan</title>
              ...
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  ...
                  <form class="form-horizontal" method="POST" action="{{ url('loginPost') }}">
                    {{ csrf_field() }}
                  <!--<input id="email" type="email" class="form-control mb-3" placeholder="Email" value="{{ old('email') }}" required autofocus />-->
                  <input id="user" type="text" class="form-control mb-3" placeholder="Username" name="user" value="{{ old('user') }}" required autofocus>
                  <!--<input id="password" type="password" class="form-control mb-1" placeholder="Password" />-->
                  
                  <input id="password" type="password" class="form-control mb-1" placeholder="Password" name="password" required>
                  ...
                  <div class="d-flex justify-content-between mt-2">
                    ...
                    <div class="forgot-password-option">
                      <a href="{{ route('password.request') }}" class="text-decoration-none text-primary">Lupa Password
                        ?</a>
                    </div>
                  </div>
