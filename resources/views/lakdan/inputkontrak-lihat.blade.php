...
<div class="main-panel">
  ...
  <div class="main-content">
    <div class="content-wrapper"><!-- Wizard Starts -->
      <div class="row">
        <div class="col-sm-12">
          <div class="content-header">INPUT KONTRAK</div>
        </div>
      </div>
          ...
          <form action="tambah" method="post" class="form" enctype="multipart/form-data" >
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <input type="hidden" class="form-control" id="khs" name="khs" value="{{ $nd->hpe->khs }}" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="selectize-multiple" multiple id="unit" name="unit[]">
                              <option value="" selected>Pilih Unit</option>
                              @foreach($unit as $u)
                              <option value='{{ $u->kode }}'>{{ $u->kantor." ".$u->nama }}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            @if($nd->hpe->metode == 'Lelang Terbatas' || $nd->hpe->metode == 'Lelang Terbuka')
                            <select class="selectize-multiple" data-placeholder=" Pilih Vendor " name="pilihvendor" required="required">
                              <option value="" selected>Pilih Unit</option>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control-file" id="upload_cover" name="upload_cover" required="required" accept="application/pdf">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload Surat Perjanjian</label>
                              <input type="file" class="form-control-file" id="upload_surat" name="upload_surat" accept="application/pdf">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload Lampiran Perjanjian</label>
                              <input type="file" class="form-control-file" id="upload_lampiran" name="upload_lampiran"  accept="application/pdf">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload Proses Pengadaan</label>
                              <input type="file" class="form-control-file" id="upload_proses" name="upload_proses"  accept="application/pdf" >
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload Dokumen Penawaran</label>
                              <input type="file" class="form-control-file" id="upload_penawaran" name="upload_penawaran" accept="application/pdf">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload Pakta Integritas</label>
                              <input type="file" class="form-control-file" id="upload_pakta" name="upload_pakta"  accept="application/pdf">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="emailAddress4">Upload HPS</label>
                              <input type="file" class="form-control-file" id="upload_hps" name="upload_hps" accept="application/pdf">
                            </div>
                          </div>
                        </div>
                        @else
                        <!-- AKHIR KALO BUKAN KHS -->

                        <!--KHS-->
                        <div class="card collapse-icon accordion-icon-rotate">
                          <div id="headingCollapse11" class="card-header pb-3">
                            <a data-toggle="collapse" href="#collapse11" aria-expanded="true" aria-controls="collapse11" class="card-title lead">PEMENANG 1</a>
                          </div>
                          <div id="collapse11" role="tabpanel" aria-labelledby="headingCollapse11" class="collapse show">
                            ...
                            <div id="headingCollapse12" class="card-header pb-3">
                              <a data-toggle="collapse" href="#collapse12" aria-expanded="false" aria-controls="collapse12" class="card-title lead collapsed">PEMENANG 2</a>
                            </div>
                            <div id="collapse12" role="tabpanel" aria-labelledby="headingCollapse12" class="collapse" aria-expanded="false">
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="firstName2">Nomor Kontrak</label>
                                    <input type="text" class="form-control" id="no_kontrak2" name="no_kontrak2" value="" required="required">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="emailAddress3">Vendor</label>
                                    <select class="selectize-multiple" data-placeholder=" Pilih Vendor " name="pilihvendor2" required="required">
                                      <option value="" selected>Pilih Unit</option>
                                      @foreach($vendor as $ven)
                                      <option value="{{ $ven->nama }}">{{ $ven->nama }}</option>
                                      @endforeach
                              ...
                              <!--<fieldset> -->
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="proposalTitle2">Upload Cover</label>
                                      <input type="file" class="form-control-file" id="upload_cover2" name="upload_cover2" required="required" accept="application/pdf">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload Surat Perjanjian</label>
                                      <input type="file" class="form-control-file" id="upload_surat2" name="upload_surat2" accept="application/pdf">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload Lampiran Perjanjian</label>
                                      <input type="file" class="form-control-file" id="upload_lampiran2" name="upload_lampiran2"  accept="application/pdf">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload Proses Pengadaan</label>
                                      <input type="file" class="form-control-file" id="upload_proses2" name="upload_proses2"  accept="application/pdf" >
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload Dokumen Penawaran</label>
                                      <input type="file" class="form-control-file" id="upload_penawaran2" name="upload_penawaran2" accept="application/pdf">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload Pakta Integritas</label>
                                      <input type="file" class="form-control-file" id="upload_pakta2" name="upload_pakta2"  accept="application/pdf">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label for="emailAddress4">Upload HPS</label>
                                      <input type="file" class="form-control-file" id="upload_hps2" name="upload_hps2" accept="application/pdf">
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div id="headingCollapse13" class="card-header pb-3">
                                <a data-toggle="collapse" href="#collapse13" aria-expanded="false" aria-controls="collapse13" class="card-title lead collapsed">PEMENANG 3</a>
                              </div>
                              <div id="collapse13" role="tabpanel" aria-labelledby="headingCollapse13" class="collapse" aria-expanded="false">
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="firstName2">Nomor Kontrak</label>
                                      <input type="text" class="form-control" id="no_kontrak3" name="no_kontrak3" value="" >
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="emailAddress3">Vendor</label>
                                      <select class="selectize-multiple" data-placeholder=" Pilih Vendor " name="pilihvendor3" >
                                        <option value="" selected>Pilih Unit</option>
                                        @foreach($vendor as $ven)
                                        <option value="{{ $ven->nama }}">{{ $ven->nama }}</option>
                                        @endforeach
                                ...
                                <!--<fieldset> -->
                                  <div class="row">
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="proposalTitle2">Upload Cover</label>
                                        <input type="file" class="form-control-file" id="upload_cover3" name="upload_cover3" accept="application/pdf">
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload Surat Perjanjian</label>
                                        <input type="file" class="form-control-file" id="upload_surat3" name="upload_surat3" accept="application/pdf">
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload Lampiran Perjanjian</label>
                                        <input type="file" class="form-control-file" id="upload_lampiran3" name="upload_lampiran3"  accept="application/pdf">
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload Proses Pengadaan</label>
                                        <input type="file" class="form-control-file" id="upload_proses3" name="upload_proses3"  accept="application/pdf" >
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload Dokumen Penawaran</label>
                                        <input type="file" class="form-control-file" id="upload_penawaran3" name="upload_penawaran3" accept="application/pdf">
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload Pakta Integritas</label>
                                        <input type="file" class="form-control-file" id="upload_pakta3" name="upload_pakta3"  accept="application/pdf">
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        <label for="emailAddress4">Upload HPS</label>
                                        <input type="file" class="form-control-file" id="upload_hps3" name="upload_hps3" accept="application/pdf">
                                      </div>
                                    </div>
                                  </div>
                                </div>
