            ...
            <div class="card">
              ...
              <div class="card-content">
                <div class="card-body">
                  ...
                  <form action="{{ url('prosespengadaan/update') }}" method="post" class="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!-- Step 1 -->
                    <!--<h6>Isi Data</h6> -->
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <textarea class="form-control" id="ket_pembuktian_kualifikasi" name="ket_pembuktian_kualifikasi" rows="2" disabled required="required"></textarea>
                              </td>
                            </tr>
                            @else
                            @endif
