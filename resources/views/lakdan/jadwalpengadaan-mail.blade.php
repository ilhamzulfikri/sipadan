...
<font face="Cambria">
  ...
  <p>Telah dilaksanakan <b>Perubahan Jadwal Pengadaaan</b> dengan data sebagai berikut :</p>
  <table id="A" style="border-collapse: collapse;table-layout:fixed;padding: 20px; border:1px solid #e3e3e3;border-radius: 5px;" class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $j->ket_pembuktian_kualifikasi }}</td>
      </tr>
      @endif
      <tr>
  ...
  @else
  <p>Pekerjaan tersebut sudah selesai dilelang dan selanjutnya akan dilaksanakan tahap <b>input kontrak</b> oleh pelaksana pengadaan.</p>
  @endif
  @endif
