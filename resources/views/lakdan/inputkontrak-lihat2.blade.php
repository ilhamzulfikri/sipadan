              ...
              <!--<fieldset> -->
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group" id="mycheckboxdiv" style="display:none">
                      ...
                      <div class='input-group'>
                        <input type='text' class="form-control date" id="no_kontrak3" name="no_kontrak3" value="" required="required">
                        <div class="input-group-append">
                          <span class="input-group-text">
                          </span>
                        </div>
                    ...
                    <div class="form-group">
                      <label for="firstName2">Nomor Kontrak 3</label>
                      <input type="text" class="form-control" id="no_kontrak3" name="no_kontrak3" value="" required="required">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      @if($nd->hpe->metode == 'Lelang Terbatas' || $nd->hpe->metode == 'Lelang Terbuka')
                          @if($nd->hpe->khs == '1')
                              <select class="form-control select2" data-placeholder=" Pilih Vendor " multiple="multiple" id="pilihvendor" name="pilihvendor[]" data-maximum-selection-length="3" required="required">
                          @else
                              <select class="form-control select2" data-placeholder=" Pilih Vendor " multiple="multiple" id="pilihvendor" name="pilihvendor[]" data-maximum-selection-length="1" required="required">
                          @endif
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" data-placeholder=" Pilih Unit " multiple="multiple" id="unit" name="unit[]" required="required">
                      @foreach($unit as $u)
